<form id="FormConfirmOtherUpdate"  method="post" action="#" class="check-needs-validation FormConfirmOther" novalidate>
            ...
            <div class="form-row">
                <div class="col-12 col-md-4 mb-2">
                    <input type="text" class="form-control" placeholder="คำนำหน้า" id="par_prefixO" name="par_prefixO"
                        value="<?=$OtherConf[0]->par_prefix?>" required11>
                </div>
                <div class="col-12 col-md-4 mb-2">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-2">
            <input type="text" class="form-control form-control" id="par_raceO" name="par_raceO"
                placeholder="ระบุเชื้อชาติ" required11 value="<?=$OtherConf[0]->par_race?>">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-2">
            <input type="text" class="form-control form-control" id="par_nationalO" name="par_nationalO"
                placeholder="ระบุสัญชาติ" required11 value="<?=$OtherConf[0]->par_national?>">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-2">
            <input type="text" class="form-control form-control" id="par_religionO" name="par_religionO"
                placeholder="ระบุศาสนา" required11 value="<?=$OtherConf[0]->par_religion?>">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control form-control" id="par_careerO" name="par_careerO"
                placeholder="ระบุลักษณะอาชีพ" required11 value="<?=$OtherConf[0]->par_career?>">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control form-control" id="par_educationO" name="par_educationO"
                placeholder="ระบุวุฒิการศึกษา" required11 value="<?=$OtherConf[0]->par_education?>">
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control form-control" id="par_salaryO" name="par_salaryO"
                placeholder="ระบุเงินเดือน/รายได้" required11 value="<?=$OtherConf[0]->par_salary?>">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        <label for="par_deceaseO" class="col-sm-3 col-form-label col-form-label">ถึงแก่กรรมเมื่อวันที่ <div
        ...
        ?>
            <div class="custom-control custom-radio ">
                <input class="custom-control-input par_serviceO" type="radio" name="par_serviceO"
                    id="par_serviceO<?=$key?>" value="<?=$v_Name?>" <?=$OtherConf[0]->par_service==$v_Name?"checked":""?>> 
                <label class="custom-control-label" for="par_serviceO<?=$key?>"><?=$v_Name?></label>
            </div>
            <?php  if($OtherConf[0]->par_service==$v_Name) : ?>
            <input type="text" class="form-control" id="par_serviceNameO<?=$key?>"
                name="par_serviceNameO[]" placeholder="ระบุ" required11 value="<?=$OtherConf[0]->par_serviceName;?>">
            <?php else :?>
            ...
            <div class="custom-control custom-radio ">
                <input class="custom-control-input par_serviceO" type="radio" name="par_serviceO"
                    id="par_serviceO99" value="ไม่ได้รับราชการ" <?=$OtherConf[0]->par_service=="ไม่ได้รับราชการ"?"checked":""?>>
